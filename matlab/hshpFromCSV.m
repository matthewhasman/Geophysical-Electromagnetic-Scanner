function [transfer_function] = hshpFromCSV(path)
primary = load('clean_primary_data_smoothed.mat');
frequencies = primary.frequencies;
primary_real = primary.data_real;
primary_imag = primary.data_imag;

[secondary_magnitude, secondary_phase, secondary_frequency] = LoadADProMeasure(path, 20);
